...
void do_codegen(asmjit::a64::Assembler& a, std::span<bfjit::BFOp const> code, asmjit::Label& exit, asmjit::Label& outside_bounds, uint32_t data_size, std::vector<size_t>& jump_offsets);
